...
# Create a link
ip link add name host1-router1 type veth peer name router1-host1 # Link between host1 and router1
ip link add name router1-router2 type veth peer name router2-router1 # Link between router1 and router2
ip link add name router2-host2 type veth peer name host2-router2 # Link between router2 and host2
